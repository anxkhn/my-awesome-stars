...
- [NothingOSS/android_kernel_msm-6.1_nothing_sm7635](https://github.com/NothingOSS/android_kernel_msm-6.1_nothing_sm7635) - Kernel Source and devicetree for NOTHING Phone(3a) , Phone(3a)Pro and Phone(4a)
...
- [a2aproject/a2a-dotnet](https://github.com/a2aproject/a2a-dotnet) - C#/.NET SDK for A2A Protocol
...
- [hridayK/Dabba-DB](https://github.com/hridayK/Dabba-DB) - A simple android app to expose local SQLite database through a server.
...
- [zapplyjobs/Internships-2027](https://github.com/zapplyjobs/Internships-2027) - 2027 tech & software engineering internships for students — new grad US roles, summer & full-year
...
- [a2aproject/a2a-java](https://github.com/a2aproject/a2a-java) - Official Java SDK for the Agent2Agent (A2A) Protocol
...
- [aryan-0077/CWA-LowLevelDesignCode](https://github.com/aryan-0077/CWA-LowLevelDesignCode) - Low Level Design Code for problems as discussed on CodeWithAryan Website
...
- [AverageMarcus/devstats-viewer](https://github.com/AverageMarcus/devstats-viewer) - Discover your CNCF devstats score based on your GitHub username
...
- [william-ricchiuti/OpenCode-goal-plugin](https://github.com/william-ricchiuti/OpenCode-goal-plugin) - Durable, guarded goal workflows for OpenCode with persistence, safety limits, agent tools, and evidence-gated completion.
...
- [anxkhn/free-kilo-gateway](https://github.com/anxkhn/free-kilo-gateway) - Add free Kilo Gateway models to OpenCode
...
- [james-yap/htmx-flask-crudapp](https://github.com/james-yap/htmx-flask-crudapp) - HTMX + Flask Crud App
...
- [TSEC-MAD-Club/MAD-Website-Obselete](https://github.com/TSEC-MAD-Club/MAD-Website-Obselete) - MAD Club's Official Website built with React.js (Next.js).
...
- [google-deepmind/formal-conjectures](https://github.com/google-deepmind/formal-conjectures) - A collection of formalized statements of conjectures in Lean.
- [leanprover/cslib](https://github.com/leanprover/cslib) - The Lean Computer Science Library (CSLib)
...
- [wingkwong/leetcode-the-hard-way](https://github.com/wingkwong/leetcode-the-hard-way) - A structured resource for learning data structures and algorithms through tutorials, templates, roadmaps, and LeetCode solution explanations. Join Discord: https://discord.com/invite/Nqm4jJcyBf
...
- [a2aproject/a2a-gateway](https://github.com/a2aproject/a2a-gateway) - A2A Gateway allowing hooking up A2A Agents to different communications channels
...
- [mplspunk/awesome-privacy-engineering](https://github.com/mplspunk/awesome-privacy-engineering) - A curated list of resources related to privacy engineering
...
- [rajput-hemant/jiosaavn-api-rs](https://github.com/rajput-hemant/jiosaavn-api-rs) - 
...
- [cysecbench/dataset](https://github.com/cysecbench/dataset) - Generative AI-based CyberSecurity-focused Prompt Dataset for Benchmarking Large Language Models
...
- [ReiDoBrega/pymonalisa](https://github.com/ReiDoBrega/pymonalisa) - A Python library to decrypt IQIYI DRM License Ticket using the MonaLisa Content Decryption Module.
...
- [ajisth69/ClashFLAC](https://github.com/ajisth69/ClashFLAC) - ClashFLAC is a full-stack music platform designed for discovering, streaming, and downloading bit-perfect lossless FLAC audio. It combines a high-performance REST API backend with a responsive retro-t
...
- [shriramkv/TheAIAgents](https://github.com/shriramkv/TheAIAgents) - Here you can get the complete guidelines helping you build AI agents! All from scratch!
...
- [Attakay78/fastapi-taskflow](https://github.com/Attakay78/fastapi-taskflow) - Turn FastAPI BackgroundTasks into a production-grade task system. Retries, Resiliency, control, and visibility without workers or brokers.
...
- [anxkhn/codex-openai-proxy](https://github.com/anxkhn/codex-openai-proxy) - Minimal OpenAI-compatible proxy powered by Codex ChatGPT OAuth subscription auth.
...
- [google-deepmind/jax_privacy](https://github.com/google-deepmind/jax_privacy) - Algorithms for Privacy-Preserving Machine Learning in JAX
...
- [S1M0N38/re-cursor](https://github.com/S1M0N38/re-cursor) - 
...
- [zai-org/RealVideo](https://github.com/zai-org/RealVideo) - A real-time streaming conversational video system that transforms text interactions into continuous, high-fidelity video responses using autoregressive diffusion.
...
- [heilcheng/openevals](https://github.com/heilcheng/openevals) - Benchmarking suite for open-weight language models
...
- [openclimatefix-archives/Elexonpy](https://github.com/openclimatefix-archives/Elexonpy) - Python package wrapper around Elexon api
...
- [0xku/leetcode-compensation](https://github.com/0xku/leetcode-compensation) - Software engineering salaries (india) from leetcode compensation
...
- [rtCamp/Frappe-Manager](https://github.com/rtCamp/Frappe-Manager) - The production platform for Frappe/ERPNext. Automatic TLS, versioned migrations, worker orchestration, isolated benches. Everything from a single CLI.
...
- [ninadnaik10/SpeakSure-desktop](https://github.com/ninadnaik10/SpeakSure-desktop) - SpeakSure is a Public Speaking Practice App aimed to improve public speaking skills. It measures speech metrics — filler words, speech pace, and confidence level and gives feedback based on them.
...
- [Altaflux/gb-rp2350](https://github.com/Altaflux/gb-rp2350) - 
...
- [vedic-lang/vedic](https://github.com/vedic-lang/vedic) - World's first working Sanskrit programming language — write code in Devanagari/Sanskrit.
...
- [caozhiyuan/copilot-api](https://github.com/caozhiyuan/copilot-api) - GitHub Copilot, OpenAI Codex, OpenCode Go, and third-party AI provider gateway with OpenAI and Anthropic API compatibility.
...
- [voidsteed/copilot-proxy-api](https://github.com/voidsteed/copilot-proxy-api) - Self-hosted GitHub Copilot bridge for Claude Code and Codex CLI with OpenAI Responses, Anthropic Messages, streaming resilience, and context management.
...
- [12fahed/CertiNova](https://github.com/12fahed/CertiNova) - Bulk certificate generator and validation platform with strict data privacy
...
- [rivet-dev/dynamic-apps](https://github.com/rivet-dev/dynamic-apps) - Deploy an AI-generated backend for every user.
...
- [silasxbt/anti-api](https://github.com/silasxbt/anti-api) - Turn Antigravity / codex / github copilot into Anthropic & Openai API compatible server. Usable with Claude Code / Xcode etc.
